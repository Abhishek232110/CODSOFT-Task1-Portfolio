    ...
    <>
      <div className="md:px-24 pl-3 md:py-16 py-4 px-4 bg-[#222831]">
        ...
        <div className="md:grid-cols-3 grid grid-cols-1 gap-10 place-items-center pt-10 ">
          <Services
            image={sc1}
            projectname="PortfoloioDesign"
            technologies="ReactJs , TailwindCss , NodeJs"
          />
          <Services
            image={sc2}
            projectname="Dhriti-Enterprises"
            technologies="NextJs , TailwindCss  "
          />
          <Services
            image={sc3}
            projectname="Frozen-Baker Web App"
            technologies="ReactJs , TailwindCss , NodeJs"
          />
          <Services
            image={sc4}
            projectname="Weather Web App"
            technologies="ReactJs ,TypeScript , TailwindCss , NodeJs"
          />
          <Services
            image={sc5}
            projectname="Frozen-Baker-Mobile-App"
